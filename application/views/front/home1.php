<div class="wraper">
  ...
  <div class="bann-lft">
  <!--<div class="circl-img"><img src="images/abbu.jpg"></div>-->
  <div class="abbu-contnt">
  <h4>Experience an award winning driving school</h4>
  <!--<span>&nbsp;</span>-->
  <p><a href="<?php echo site_url("about-us"); ?>">Learn More</a></p>
  </div>
  </div>
  ...
  <?php if(validation_errors()) { ?>
    ...
    <?php } ?>
    <div id="dv_error_reg"></div>
  <form method="post" id="frm_register_with_us" action="" onsubmit="return register_with_us(this);">
  <div class="padd10"> 
  <div class="form-group">
  <i class="fa fa-user" aria-hidden="true"></i>
   <input class="form-control" id="txt_name" name="txt_name" placeholder="Enter Your Name" type="text" maxlength="50" required> </div>
   <div class="form-group">
   <i class="fa fa-envelope" aria-hidden="true"></i>
   <input class="form-control" id="txt_email_id" name="txt_email_id" placeholder="Enter Your Email" type="email" maxlength="50" required> </div>
   <div class="form-group">
   <i class="fa fa-phone" aria-hidden="true"></i>
   <input class="form-control" id="txt_mobile_no" name="txt_mobile_no" placeholder="Enter Your Phone" type="text" maxlength="10" required onKeyUp="validate_onkeyup(this);" onBlur="validate_onblure(this);"> </div>
   <button type="submit" class="btn btn-default">Submit</button>
   </div>
  </form>
  </div>
	<div class="topf-icoo"><img src="<?php echo base_url("assets/images/edit.png"); ?>"></div>  
  </div>
  </div>
    <ul class="bxslider">
      <li>
        <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/banner-s.jpg"); ?>" alt=""></figure>
      </li>
    </ul>
  </div>
</div>
          ...
          <div class="kode_mosque_row">
            <div class="kode_mosque_des">
              <div class="kode_mosque_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/instrct_1.jpg"); ?>" alt="" />
                  <!--<figcaption>
              ...
              <div class="kode_mosque_fig">
                <figure class="them_overlay"> <img height="198px;" src="<?php echo base_url("assets/images/instrct_2.jpg"); ?>" alt="" />
                  <!--<figcaption>
            ...
            <div class="kode_mosque_des">
              <div class="kode_mosque_fig">
                <figure class="them_overlay"> <img height="385px" src="<?php echo base_url("assets/images/instrct_3.jpg"); ?>" alt="" />
                  <!--<figcaption>
    ...
    <div class="container"> 
      ...
      <div class="row">
          ...
          <div class="kode_service_des">
            ...
            <div class="kode_service_text">
             <span><i class="fa fa-taxi"></i></span>
              ...
              <a class="right_arrow hvr-ripple-out" href="<?php echo site_url("light-motor-driving"); ?>"><i class="fa fa-arrow-right"></i></a>
            </div>    
          </div>
          </a>
        </div>
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="kode_service_des">
            <figure> <img src="<?php echo base_url("assets/images/family_d.png"); ?>" alt=""> </figure>
            <div class="kode_service_text"> <span><i class="fa fa-taxi"></i></span>
  ...
  <div class="kode_pray_wrap them_overlay"> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="video">
            <a href="<?php echo site_url("company-introductions"); ?>" target="_blank"><i class="fa fa-play-circle-o" aria-hidden="true"></i></a>
            <h5>SEE <span>VIDEO COURSEs </span></h5>
            <p>SELECT THE RIGHT COURSE FOR YOU</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="gallery-slide">
          ...
          <div class="kode_gallery3_row">
            <div class="kode_gallery3_des">
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g.jpg"); ?>" alt=""> </figure>
              </div>
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g1.jpg"); ?>" alt=""> </figure>
              </div>
            </div>
            <div class="kode_gallery3_fig fig_2">
              <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g2.jpg"); ?>" alt=""> </figure>
            </div>
            <div class="kode_gallery3_des">
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g4.jpg"); ?>" alt=""> </figure>
              </div>
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g5.jpg"); ?>" alt=""> </figure>
              </div>
            </div>
          </div>
        </div>
        <div>
          <div class="kode_gallery3_row">
            <div class="kode_gallery3_des">
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g7.jpg"); ?>" alt=""> </figure>
              </div>
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g8.jpg"); ?>" alt=""> </figure>
              </div>
            </div>
            <div class="kode_gallery3_fig fig_2">
              <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g6.jpg"); ?>" alt=""> </figure>
            </div>
            <div class="kode_gallery3_des">
              <div class="kode_gallery3_fig">
                <figure class="them_overlay"> <img src="<?php echo base_url("assets/images/member_g.jpg"); ?>" alt=""> </figure>
      ...
      <div class="kode-team-slide">
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Ishawar-Mishra-Trainer.jpg"); ?>" alt="">
              <figcaption>
                <h4>Ishawar Mishra</h4>
                <p>Trainer</p>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Mohamed Ewida - Trainer.jpg"); ?>" alt="">
              <figcaption>
                <h4>Mohamed Ewida</h4>
                <p>Trainer</p>
              </figcaption>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Muhammed Jakir - Instructor.jpg"); ?>" alt="">
              <figcaption>
                <h4>Muhammed Jakir</h4>
                <p>Instructor</p>
              </figcaption>
            </figure>
          </div>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Rania-Moustafa-Instructor.jpg"); ?>" alt="">
              <figcaption>
                <h4>Rania-Moustafa</h4>
                <p>Instructor</p>
              </figcaption>
            </figure>
          </div>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Roshanbi-Instructor.jpg"); ?>" alt="">
              <figcaption>
                <h4>Roshanbi</h4>
                <p>Instructor</p>
              </figcaption>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Shahudeen Tangal - Trainer.jpg"); ?>" alt="">
              <figcaption>
                <h4>Shahudeen Tangal</h4>
                <p>Trainer</p>
              </figcaption>
            </figure>
          </div>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Shaji PK Instructor.jpg"); ?>" alt="">
              <figcaption>
                <h4>Shaji PK</h4>
                <p>Instructor</p>
              </figcaption>
        ...
        <div>
          <div class="kode_tem_fig">
            <figure> <img src="<?php echo base_url("assets/images/team-Walid-Abdelhalim-Lecturer.jpg"); ?>" alt="">
              <figcaption>

                <h4>Walid-Abdelhalim</h4>
                <p>Lecturer</p>
              </figcaption>
            </figure>
          </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
       <h4>Chairman's Word</h4>
       <img src="<?php echo base_url("assets/images/abbu.jpg"); ?>">
       <p>When we look back at the years from 1980 up to the year 2012 and beyond, we realize that there is no doubt that we have grown and are prospering in our field whilst also overcoming the challenges and difficulties we faced.</p>
       <h3>Ali Bujsaim</h3>
   ...
   //$("#loading").css('display','block');
    ...
    $.ajax({
        ...
        success: function(response)
        {
			...
			setTimeout(function(){$("#dv_error_news").html('');},20000);
   ...
   //$("#loading").css('display','block');
    ...
    $.ajax({
        ...
        success: function(response)
        {
		  ...
		  // $("#loading").css('display','none');
		  setTimeout(function(){$("#dv_error_reg").html('');},20000);
       }
    });
    return false;
}
