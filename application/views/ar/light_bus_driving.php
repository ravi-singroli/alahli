...
<p>إن مضمون هذه الدورة هو نفس المضمون التقني الموجود في الدورات الأخرى مع وجود إضافة لمواضيع تتعلق بالتأكيد على سلامة الركاب . وينبغي على السائق ضمان سلامة الركاب خصوصاً الاطفال حيث يتوجب عليه التأكد من جلوس الأطفال على المقاعد ونزولهم وصعودهم بشكل سليم . كما ينبغي على السائق معرفة مايتوجب عليه فعله في حالات الطوارئ مثل الحرائق أو الحوادث.</p>
          ...
          <hr />
          <h3>الارشادات العامة:</h3>
          <ul class="disc">
            <li>يمكن الحصول على رخصة القيادة للمركبة الثقيلة (الشاحنات) للذين يبلغ أعمارهم (٢0 عاما) (تطبق قوانين هيئة الطرق والمواصلات)</li>            
          </ul>
...
المستندات المطلوب</h3>
        ...
        <div role="tabpanel" class="tab-pane" id="lectures-details">
          ...
          <p><strong>بعد استلام الطالب تصريح التعليم الخاص بالحافلات الخفيفة (الباصات) يجب علية حضور المحاضرات النظرية والتى تتناول العديد من المواضيع كالاتى :</strong></p>
  ...
  <td>المحاضرة الثامنة</td>
    <td>دراسة حالات لحوادث    مرورية وكيف يجب التصرف فى حال الحادث</p></td>
    
  </tr>
</table>
          <div class="note-bottom"> ملاحظة: يجب على الطالب استكمال جميع المحاضرات 8 واجتاز اختبار المعرفة هيئة الطرق والمواصلات قبل الحجز التدريب العملي.</div>
        </div>
          ...
          <table border="1" cellspacing="0" cellpadding="0" width="100%" class="fees-table">
            ...
            <tr>
             ...
             <tr>
              ...
              <td>القوز الصناعية رقم 4</td>
              <td>مركز الاهلى لتعليم قيادة السيارات </td>
              <td>بعد النجاح فى الاختبار النظرى والفحص التجريبى والانتهاء من جميع الساعات التدريبية العملية</td>
            </tr>
            <tr>
              <td>اختبار الطريق</td>
              <td>القوز الصناعية رقم 4</td>
        ...
        <div role="tabpanel" class="tab-pane" id="training-details">
          ...
          <table border="1" cellpadding="0" cellspacing="0" width="100%" class="fees-table">
            ...
            <tr>
              <td rowspan="3">التدريب الداخلي ( داخل محيط المعهد) ويتكون من (8)ساعات تدريبية عملية</td>
              <td >التحكم والسيطرة
             </td>
            </tr>
            <tr>
            ...
            <tr>
              <td rowspan="3">التدريب الخارجي (خارج محيط المعهد)
ويتكون من (1٢) ساعة تدريبية عملية
</td>
              <td>القيادة فى شوراع مختلفة السرعة
				</td>
            </tr>
            <tr>
