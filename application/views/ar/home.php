...
<div class="mobile_form">
  ...
  <div class="kode_pray_wrap them_overlay"> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="video"> <a href="<?php echo site_url("company-introductions"); ?>" target="_blank"><i class="fa fa-play-circle-o" aria-hidden="true"></i></a>
            <h5>GUIDE</h5>
            <p>Step by step guide to get a license</p>
          </div>
        </div>
      </div>
    </div>
